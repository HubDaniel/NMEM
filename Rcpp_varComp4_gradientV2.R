...
vec lp(vec& eta, vec& tiid, vec& tiidc, vec& Y1, vec& Y2, vec& w1, vec& w2, List& G1, List& G2, List& Z, List& E);


vec lp(vec& eta, vec& tiid, vec& tiidc, vec& Y1, vec& Y2, vec& w1, vec& w2, List& G1, List& G2, List& Z, List& E){

  double K1, K, eta1, eta2, eta3, eta4, eta5, eta6, eta7, eta8, idsL, ni, w1_i, w2_i, d1, d2, d3, d4, d5, d6, d7, d8;
  vec Y1i, Y2i, gr;
  mat V1_i, V2_i;
  ...
  //std::cout << "gr-1st for finished" << std::endl;
...
lp4_grV2 = cxxfunction(signature( eta_in="numeric",tiid_in='numeric',tiidc_in='numeric',Y1_in='numeric',Y2_in='numeric',
